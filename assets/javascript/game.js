$(document).ready(function() {
    ...
    let characters = {
        "Beethoven": {
            ...
            health: 120,
            attack: 8,
            imageUrl: "assets/images/Beethoven.jpg",
            enemyAttackBack: 15
        }, 
        "Mozart": {
            name: "Mozart",
            health: 100,
            attack: 14,
            imageUrl: "assets/images/Mozart.jpg",
            enemyAttackBack: 5
        }, 
        "Bach": {
            name: "Bach",
            health: 150,
            attack: 8,
            imageUrl: "assets/images/Bach.jpg",
            enemyAttackBack: 20
        }, 
        "Tchaikovsky": {
            name: "Tchaikovsky",
            health: 180,
            attack: 7,
            imageUrl: "assets/images/Tchaikovsky.jpg",
            enemyAttackBack: 20
        }
    };
    ...
    var renderOne = function(character, renderArea, makeChar) {
      ...
      var renderCharacters = function(charObj, areaRender) {
        ...
        if (areaRender == '#selected-character') {
          ...
          renderOne(charObj, areaRender, 'enemy');
